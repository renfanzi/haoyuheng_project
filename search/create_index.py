...
from search.add_index import incremental_index
...
def app():
    ...
    """
    indexDirectory = r'C:\Users\Administrator\Desktop\航天项目爬虫目录\crawling_baidu_academic\index_dir'
    dbname = 'haoyuheng'
    uniqueValue = ['article_id']
    # 字段名
    columnName = [
        "id",
        "article_name",
